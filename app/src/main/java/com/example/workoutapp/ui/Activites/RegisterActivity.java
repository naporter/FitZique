    ...
    private void ValidatephoneNumber(final String name, final String phone, final String password, final int points) {
        ...
        rootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        loadingBar.dismiss();
                                        Toast.makeText(RegisterActivity.this, "Network Err: Please try again.", Toast.LENGTH_SHORT);
                                    }
                                }
                            });
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(RegisterActivity.this, "database error", Toast.LENGTH_SHORT);
            }
        });
    }
}
